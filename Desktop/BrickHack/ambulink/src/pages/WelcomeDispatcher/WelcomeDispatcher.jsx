...
function WelcomeDispatcher() {
  ...
  const [state, setState] = useState(AMBULANCE_ON_WAY_STATE);
  const [address, setAddress] = useState("123 Test Avenue, Rochester, NY.");
          ...
          <div className="popup-flex">
            ...
            <div className="available-ambulances">
              <AmbulanceSelection
                ...
                arrivalTime="5 min"
                onClick={() => {
                  setSelectedAmbulanceLicensePlate("GGC1234");
                }}
              ></AmbulanceSelection>
            </div>
